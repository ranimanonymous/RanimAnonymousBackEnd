...
class changePasswordParamValidation extends Model
{
    public static function Validate($request){
        ...
        $msg = paramvalidation::checkAttributes($request, $msg, 'sessionkey');
//                $msg = paramvalidation::checkAttributes($request, $msg, 'actionName');
        $msg = paramvalidation::checkAttributes($request, $msg, 'password');
        $msg = paramvalidation::checkAttributes($request, $msg, 'newpassword');
